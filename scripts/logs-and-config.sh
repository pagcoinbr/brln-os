...
declare -A SERVICE_CONFIG=(
    ...
    ["brln-api"]="brln-api:/home/admin/brln-os/api/v1/app.py,/data/brln-wallet/:BRLN-OS API configuration and data"
    ["messager-monitor"]="brln-api:/home/admin/brln-os/api/v1/messager_monitor_grpc.py:Lightning message monitor configuration"
    ["gotty-fullauto"]="root:/home/admin/brln-os/scripts/menu.sh:Terminal web interface script"
