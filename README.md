...
E depois `git clone https://github.com/REDACTED_USERbtc/minibolt-semiauto-v0.2.git`
...
Baixe o repositório no usuário lnd `git clone https://github.com/REDACTED_USERbtc/minibolt-semiauto.git`
